...
public class CounterTerrorist {
	 ...
	 * c CounterTerrorist(String,Weapon)
	 * c CounterTerrorist(String,Weapon,int,int)
	 * - setName(String):void
	 * + getName():String
	 * - setHealth(int):void
	 * + getHealth():int
	...
	private static int livingCounterTerrorists = 0;
	...
	public CounterTerrorist(String name, Weapon weapon) {
		this.setName(name);
		this.setHealth(100);
	...
	public CounterTerrorist(String name, Weapon weapon, int x, int y) {
		this.setName(name);
		this.setHealth(100);
		this.setWeapon(weapon);
	 ...
	 * 		the livingCounterTerrorist count.
	 */
	...
	public static int getActorCount() {
		return CounterTerrorist.actorCount;
	}
	
	public static int getLivingCount() {
		return CounterTerrorist.livingCounterTerrorists;
	}
	...
	public void printIntroduction() {
		System.out.println("Counter Terrorist "+this.getName()+" has been created.");
	}
	...
	public static void printActorCount() {
		System.out.println("There are "+CounterTerrorist.actorCount+" Counter Terrorists in the game.");
	}

	public static void printLivingCount() {
		System.out.println("There are "+CounterTerrorist.livingCounterTerrorists+" Counter Terrorists still alive.");
	}
	 ...
	 */
	public void shoot(Terrorist enemy) {
		...
		// Else
			...
			if(enemy.getAlive()){
				System.out.println(this.getName()+": I'm shooting at Terrorist "+enemy.getName()+" with  my "+this.getWeapon()+".");
				enemy.beingShot(this, ammo.pop());
			}
			// Otherwise, well, they're dead
			else{
				System.out.println(this.getName()+": I was going to shoot at Terrorist "+enemy.getName()+" but they're already dead!");
			}
		}
	}
	 ...
	 * 		new health status
	 */
	public void beingShot(Terrorist enemy, Bullet b) {
		...
		System.out.println(this.getName()+": I was shot by Terrorist "+enemy.getName()+" for "+damage+" damage from a distance of "+SharedMethods.get2dDistance(this.getX(), this.getY(), enemy.getX(), enemy.getY())+"!");
		// Update health
	...
	private void die() {
		System.out.println("Counter Terrorist "+ this.getName()+" has died.");
		this.setAlive(false);
	}
